...
if __name__ == "__main__":
    ...
    parser.add_argument('--prompt_path',type=str,default='/home/wenyu/Clip_prompt/sava/seed1/prompt_model_89.pt')
    parser.add_argument('--clip_path',type=str,default='/home/wenyu/Clip_prompt/sava/seed1/Image_encoder_tuning89.pt')
    ...
    text_fea = prompt_test.main_worker(args,train_dataloader)
    clip_model_vit16,preprocess = clip.load("ViT-B/16",device=device)
    if args.image_enc==1:
    ...
    with torch.no_grad():
            ...
            for i in range(len(test_dataloader)):
                images, pesu_label,clinical_prompt,file_id= next(iter_test) 
                # if pesu_label.cpu().numpy()[0][0]  ==0:
                #     continue
